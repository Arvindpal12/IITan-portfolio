    ...
    <div id="Skills" className="w-full p-4 sm:p-8 md:p-16 lg:p-20 xl:p-24 mx-auto max-w-7xl">
      ...
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mt-12 pt-12 border-t border-zinc-700/50 w-full">
          <div className="group p-4 sm:p-8 md:p-10 bg-zinc-950/60 backdrop-blur-md rounded-3xl hover:bg-zinc-900/70 transition-all duration-300 flex flex-col h-[250px] sm:h-[280px] justify-between hover:shadow-2xl">
