...
import { FaUsers, FaProjectDiagram, FaDesktop, FaComment, FaLightbulb, FaClock, FaChartBar } from "react-icons/fa";
...
const Skills = () => {
  return (
    <div id="Skills" className="w-full p-4 sm:p-8 md:p-16 lg:p-20 xl:p-24 mx-auto max-w-7xl">
      <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-black font-bold text-left pl-4 sm:pl-0 mb-8">Skills</h1>
