...
const Home = () => {
    return (
        <div id="home" className='bg-[#F7F7F7]  text-black flex flex-col md:flex-row w-full h-auto justify-between items-center md:items-end p-5 md:p-10 lg:p-20 gap-8 relative pb-[50px]'>
