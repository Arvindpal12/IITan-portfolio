...
const Home = () => {
    return (
        <div id="home" className='bg-[#F7F7F7]  text-black flex flex-col md:flex-row w-full h-auto justify-between items-center md:items-end p-5 md:p-10 lg:p-20 gap-8 relative pb-[50px] pt-[50px]' style={{position:"relative",top:"50px"}}>
            <div className='w-full md:w-1/2 md:pt-10 relative z-10 text-center md:text-left'>
                ...
                <a href='https://wa.me/9773657224'target='blank'>
            ...
            <div className='w-full md:w-1/2 flex items-end justify-center relative z-20 md:ml-16'><img className='w-[60%] md:w-[70%] lg:w-[85%] max-w-xs md:max-w-md lg:max-w-lg h-auto aspect-square object-cover animate-updown rounded-full mt-[50px]    ' src={ritikimage} alt="" /></div>
        </div>
    )
}
